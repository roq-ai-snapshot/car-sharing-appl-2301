  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the convenience of collaborative commuting with Car Sharing Application - Your key to economical and eco-friendly travel."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the convenience of collaborative commuting with Car Sharing Application - Your key to economical and eco-friendly travel.`}
            </Text>
            <Box
